...
class Usuario(models.Model):
    ...
    perfil = models.CharField("Imagem para o perfil",max_length=1500, null=True, blank=True)
...
class Publicacao(models.Model):
    capa = models.CharField("Capa da publicação",max_length=1500,null=True,blank=True)
    ...
    capa_secao1 = models.CharField("Imagem da Seção 1",max_length=1500,null=True,blank=True)
    ...
    capa_secao2 = models.CharField("Imagem da Seção 2",max_length=1500,null=True,blank=True)
